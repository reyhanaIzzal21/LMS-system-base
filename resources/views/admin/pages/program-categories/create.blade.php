...
@section('content')
    <div class="container mx-auto px-4 py-8 max-w-3xl">
        <div class="mb-8">
            ...
            <h1 class="text-3xl font-bold text-slate-800 tracking-tight">Tambah Kategori Program</h1>
            <p class="text-slate-500 text-sm mt-1">Buat kategori baru untuk mengelompokkan program.</p>
        </div>
