...
@section('content')
    <div class="container mx-auto px-4 py-8 max-w-4xl">
        <div class="mb-8">
            ...
            <h1 class="text-3xl font-bold text-slate-800 tracking-tight">Tambah Program</h1>
            <p class="text-slate-500 text-sm mt-1">Buat program bimbel atau kursus baru.</p>
        </div>
            ...
            <form action="{{ route('programs.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <select name="program_category_id" id="program_category_id"
                            ...
                            @foreach ($categories as $category)
                                <option value="{{ $category->id }}"
                                    {{ old('program_category_id') == $category->id ? 'selected' : '' }}>
                                    {{ $category->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="description" id="description" rows="5"
                        ...
                        placeholder="Deskripsi lengkap tentang program ini">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    ...
                    <div id="price-field" class="{{ old('is_premium') == '1' ? '' : 'hidden' }}">
                    ...
                    <div id="promo-field" class="{{ old('is_premium') == '1' ? '' : 'hidden' }}">
                        ...
                        <input type="number" name="promotional_price" id="promotional_price"
                            value="{{ old('promotional_price') }}" min="0"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <p class="text-xs text-slate-400 mt-1">Format: JPG, PNG, GIF, WebP. Max 2MB</p>
                        @error('thumbnail')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
...
@section('script')
    <script>
        ...
        // Initialize price fields visibility on page load
